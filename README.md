...
!!!!This notation cannot be used in NovelAI, please use it in Anything-v3.0!!!!
!!!!這種表示法無法使用在NovelAI 請使用在Anything-v3.0!!!!
!!!!この表記は NovelAI では使用できません。Anything-v3.0 で使用してください。!!!!
